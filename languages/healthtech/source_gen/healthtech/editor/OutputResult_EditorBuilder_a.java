...
/*package*/ class OutputResult_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_natwkn_a1a() {
    return !(SEnumOperations.isMember(SPropertyOperations.getEnum(myNode, PROPS.status$fHvE), 0x6c0fdc58b27e8d0fL));
  }
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.status$fHvE;
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new actionSingleRoleHandler_natwkn_b0(myNode, LINKS.action$fHIc, getEditorContext());
  ...
  private static class actionSingleRoleHandler_natwkn_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.action$fHIc, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.action$fHIc, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.action$fHIc);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.action$fHIc));
      try {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.result$CjFw;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
